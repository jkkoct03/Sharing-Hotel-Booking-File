...
public class UserController {
	...
	public void updateUser(@RequestBody User user) {
		...
		if(existingUser != null && existingUser.getBonusPoints() != user.getBonusPoints()) {
			...
			List<HotelBooking> userPendingApprovalHotelRoomBookings = hotelBookingDAO.findByUserIdAndBookingStatus(existingUser.getId(), PENDING_APPROVAL.name());
